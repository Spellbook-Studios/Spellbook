...
/**
 * Fork of imgui.gl3.ImGuiImplGl3 written by the bindings author, made so it works with this engine
 *
 * @since 1.0.0
 * @author sebsa (Mostly SpaiR)
 */
public class SpellbookImGuiImplGl3 {
